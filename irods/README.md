...
`load_balancer_admin_email`                | root@`inventory_hostname`            |         | the email address assigned to the TLS certificates generated by Let's Encrypt for the HAProxy's stats port
